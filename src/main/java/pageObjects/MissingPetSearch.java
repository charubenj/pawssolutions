...
public class MissingPetSearch extends base {
	...
	//By petSearch = By.xpath("/html/body/div[1]/div/div[1]/nav/div/ul/li[2]/a");
		...
		By lostBtn= By.xpath ("//*[text()='lost']");
		
		public MissingPetSearch(WebDriver driver) {
			this.driver=driver;
		}
		...
		public WebElement filterSelection() {
	       ...
	       public WebElement lostBtn() {
	    	   return this.driver.findElement(lostBtn);
	       }
	      }
